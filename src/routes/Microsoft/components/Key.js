  ...
  render() {
    return (
      <div style={styles.container}>
        <img alt="" src="http://omoxprgv1.bkt.clouddn.com/9am_logo.png" style={{ width: '200px', height: '60px' ,marginBottom:10}} />
        <font style={{ fontSize: 30, color: '#a5a6ab' }}>X</font>
        <img alt="" src="http://omoxprgv1.bkt.clouddn.com/microsoft_logo.png" style={{ width: '180px', height: '80px', marginLeft: '16px' }} />
        <div style={{ flex: 1 }} />
